...
//				
				if (user.getRole().equals("voter")) {
					 ...
					 * -empty 3. Clnt browser -chks privacy settings cookies blocked -- cookies
					 * won't be stored--can't remember the clnt accepted -- cookie age --def value
					 * -1 => saves it in cache(cookie storage) 4. clnt browser - sends NEXT req
